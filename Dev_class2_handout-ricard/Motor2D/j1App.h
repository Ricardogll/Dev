...
private:
	...
	bool mutable needssave = false; // mutable para que en un metodo constante podamos cambiar las variables de la clase
	bool mutable needsload = false;
